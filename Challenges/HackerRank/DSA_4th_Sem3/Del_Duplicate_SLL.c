...
SinglyLinkedListNode *removeDuplicates(SinglyLinkedListNode *llist)
{
    ...
    SinglyLinkedListNode *traverser = llist->next;
    SinglyLinkedListNode *duplicateAnchor = llist;

    while (traverser)
    {
        if (duplicateAnchor->data != traverser->data)
        {
            duplicateAnchor = traverser;
        }
        else
        {
            duplicateAnchor->next = traverser->next;
        }
